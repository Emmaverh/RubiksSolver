...
#          |O7|O8|O9|
        ...
        kubus_emma[0][0]=kubusGraph["w"][9-1][0].upper()
        kubus_emma[0][0]+=kubusGraph["g"][7-1][0].upper()
        kubus_emma[0][0]+=kubusGraph["o"][3-1][0].upper()
        kubus_emma[0][1]=kubusGraph["w"][8-1][0].upper()
        kubus_emma[0][1]+=kubusGraph["o"][2-1][0].upper()
